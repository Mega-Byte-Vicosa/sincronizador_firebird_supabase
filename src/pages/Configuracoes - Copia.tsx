  ...
  async function carregarConfiguracoes() {
    ...
    const { data, error } = await supabase
      ...
      .select(
        ...
        metodo_envio_texto,
        formato_payload,
        ultimo_status_instancia,
        ultimo_status_em,
        ultimo_profile_name,
        ultimo_profile_pic_url,
        ultimo_connected,
        ultimo_logged_in,
        ultimo_qrcode_em
      `
    ...
    if (error) {
      console.error("Erro ao carregar configurações BTZap:", error);
    ...
    const config = data as BtzapConfigData;

    console.log("Configuração BTZap carregada:", config);
    ...
    <main className="settings-page">
      ...
      <section className="settings-panel">
        <div className="panel-title">
          ...
          <span>Token protegido por função server-side</span>
        </div>
        ...
        <div className="btzap-connection-panel">
          <div className="panel-title">
            ...
            <span>QR Code temporário protegido por função server-side</span>
          </div>

          <div className="btzap-connection-form">
            <label>
              <span>Telefone para conexão</span>
              <input
                placeholder="Ex: 5531987485047"
            ...
            <div className="settings-actions btzap-connection-actions">
              ...
              >
                {gerandoQrCode ? "Gerando QR Code..." : "Gerar QR Code"}
              </button>
